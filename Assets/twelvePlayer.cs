...
public class twelvePlayer : MonoBehaviour
{
    // Start is called before the first frame update
    public TextMeshProUGUI mytext;
    public TextMeshProUGUI buttonText;
    private List<string> Roles = new List<string> { "God Father", "Killer Mafia" ,"Mafia", "Professional Mafia", "Investigator", "Doctor", "Sniper", "freemason", "savior" , "Citizen", "Citizen", "Mayor" };
