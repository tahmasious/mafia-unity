...
public class tenPlayerLogic : MonoBehaviour
{
    public TextMeshProUGUI mytext;
    public TextMeshProUGUI buttonText;
    private List<string> Roles = new List<string> { "God Father", "Mafia", "Professional Mafia", "Investigator", "Doctor", "Sniper", "Citizen", "Citizen", "Citizen", "Mayor" };
